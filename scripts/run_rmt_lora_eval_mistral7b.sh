#!/bin/bash
# 5-seed x 4-position eval for the Mistral 7B RMT-LoRA checkpoint.
# Mirrors run_rmt_lora_eval{,_llama8b}.sh.
...
LORA_DIR=./checkpoints/rmt_lora_mistral7b_n16_r16_bptt2_t5000_s42/lora_final
MEM_CKPT=./checkpoints/rmt_lora_mistral7b_n16_r16_bptt2_t5000_s42/final.pt
TAG=mistral-7b-v0_3
